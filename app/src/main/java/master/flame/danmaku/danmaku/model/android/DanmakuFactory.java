...
public class DanmakuFactory {
    ...
    public BaseDanmaku copyDanmaku(BaseDanmaku danmaku, DanmakuContext context) {
        if (danmaku == null) {
            return null;
        }
        BaseDanmaku copy = createDanmaku(danmaku.getType(), context);
        if (copy == null) {
            return null;
        }
        copy.copyDanmaku(danmaku, context);
        copy.filterResetFlag = -1;
        return copy;
    }

    public BaseDanmaku copySpecialDanmaku(SpecialDanmaku danmaku, DanmakuContext context, float scaleX, float scaleY) {
        if (danmaku == null || danmaku.getType() != BaseDanmaku.TYPE_SPECIAL) {
            return null;
        }
        SpecialDanmaku copy = (SpecialDanmaku) createDanmaku(BaseDanmaku.TYPE_SPECIAL, context);
        if (copy == null) {
            return null;
        }
        copy.copyDanmaku(danmaku, context);
        copy.copySpecialDanmaku(danmaku, scaleX, scaleY);
        return copy;
    }
