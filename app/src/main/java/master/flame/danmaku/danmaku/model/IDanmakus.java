...
public interface IDanmakus {
    ...
    IDanmakus subNewSet(long startTime, long endTime);
    ...
    @Nullable
    BaseDanmaku get(Checker checker);
    ...
    class WeightComparator extends BaseComparator {

        public WeightComparator(boolean duplicateMergingEnabled) {
            super(duplicateMergingEnabled);
        }
        ...
        public int compare(BaseDanmaku obj1, BaseDanmaku obj2) {
            ...
            int r = Integer.compare(obj1.weight, obj2.weight);
            if (r != 0) {
                return r;
            }
            return DanmakuUtils.compare(obj1, obj2);
    ...
    interface Checker {
        boolean check(BaseDanmaku baseDanmaku);
    }
}
