...
/**
 * 复制于LinearSmoothScroller源码
 *
 * 魔改动画插值器，以及滚动速度
 */
public class NewDanmuSmoothScroller extends RecyclerView.SmoothScroller {

    private static final boolean DEBUG = false;

    static final float MILLISECONDS_PER_INCH = 350f;
    ...
    protected float mSpeedInterval = MILLISECONDS_PER_INCH;
    ...
    public NewDanmuSmoothScroller(Context context) {
...
//        final int time = calculateTimeForDeceleration(distance);
    ...
    protected float calculateSpeedPerPixel(DisplayMetrics displayMetrics) {
        return mSpeedInterval / displayMetrics.densityDpi;
    }
