 ...
 */
public class UniformScroller extends RecyclerView.SmoothScroller {

    private static final String TAG = "LinearSmoothScroller";

    private static final boolean DEBUG = false;

    private float speedPerInch = 1000f;
    ...
    public UniformScroller(Context context) {
    ...
    protected float calculateSpeedPerPixel(DisplayMetrics displayMetrics) {
        return speedPerInch / displayMetrics.densityDpi;
    }
