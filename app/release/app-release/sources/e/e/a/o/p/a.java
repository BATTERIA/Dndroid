...
public class a extends h<View> {
    /* Return type fixed from 'java.lang.Object' to match base method */
    @Override // e.e.a.y.a.b.h
    public View a(c cVar, Object[] objArr) {
        return new View(this.f4585a, cVar, (objArr.length <= 0 || objArr[0] == null) ? null : String.valueOf(objArr[0]));
    }
    ...
    public Object a(View view, String str, Object[] objArr) {
        ...
        switch (c2) {
            case 0:
                ...
                view2.appendChild((j) ((e.e.a.x.a) this.b).a(j));
                return null;
            case 1:
                if (objArr.length > 0 && objArr[0] != null) {
                    j = ((Number) objArr[0]).longValue();
                }
                view2.removeChild((j) ((e.e.a.x.a) this.b).a(j));
                return null;
            case 2:
                view2.removeAll();
                return null;
            case 3:
                ...
                view2.insertBefore(jVar, (j) ((e.e.a.x.a) this.b).a(j));
                return null;
            case 4:
                ...
                view2.replaceChild(jVar2, (j) ((e.e.a.x.a) this.b).a(j));
                return null;
            case 5:
                if (objArr.length > 0 && objArr[0] != null) {
                    str2 = String.valueOf(objArr[0]);
                }
                return view2.getElementById(str2).getJSValue();
            case 6:
                view2.layout();
                return null;
            case 7:
