...
public final class t {
    ...
    public static Method f3354a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f3354a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f3354a) != null) {
            try {
