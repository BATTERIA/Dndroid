        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == h.ConstraintSet_android_alpha) {
                    ...
                    this.w0 = obtainStyledAttributes.getFloat(index, f2);
                }
            }
        }
    }
    ...
    public c getConstraintSet() {
        ...
        if (cVar != null) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (id != -1) {
                    if (!cVar.f3211a.containsKey(Integer.valueOf(id))) {
                        cVar.f3211a.put(Integer.valueOf(id), new c.a());
                    }
                    c.a aVar2 = cVar.f3211a.get(Integer.valueOf(id));
